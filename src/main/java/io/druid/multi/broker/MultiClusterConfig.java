...
public class MultiClusterConfig
{
  ...
  private List<String> zkHosts = Lists.newArrayList("localhost");

  @JsonProperty("brokerServiceName")
  private String brokerServiceName = TieredBrokerConfig.DEFAULT_BROKER_SERVICE_NAME;
